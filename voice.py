...
def sendEmail(to, content):
    ...
    server.login('your email id', 'password') #email id and password.
    server.sendmail('your email id', to, content) # email id , to, content
    server.close()
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "Sneha" in command:
            ...
            speak("I'm an virtual assisatnt, cant be ur gf or bf.")
            ...
            ec.capture(0, "My Webcam ", "img.jpg")
...
Label(wn, text='Welcome to meet my Voice Assistant', bg='LightBlue1',
